...
class SanwasDBManager(DatabaseManagerBase):
    def __init__(self):
        super().__init__()
        self.username = os.getenv("SANWAS_DB_USER")
        self.password = os.getenv("SANWAS_DB_PASSWORD")
        self.host = os.getenv("SANWAS_DB_HOST")
        self.port = os.getenv("SANWAS_DB_PORT")
        self.database = os.getenv("SANWAS_DB_NAME")
        self.initialize()
...
class PleasanterDBManager(DatabaseManagerBase):
    def __init__(self):
        super().__init__()
        self.username = os.getenv("PLEASANTER_DB_USER")
        self.password = os.getenv("PLEASANTER_DB_PASSWORD")
        self.host = os.getenv("PLEASANTER_DB_HOST")
        self.port = os.getenv("PLEASANTER_DB_PORT")
        self.database = os.getenv("PLEASANTER_DB_NAME")
        self.initialize()
