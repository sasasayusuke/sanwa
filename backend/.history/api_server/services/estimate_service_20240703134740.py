...
class EstimateService:
    ...
    def get_estimate(self, estimate_number: int):
        return self.repository.get_by_id(estimate_number)

    def list_estimates(self, skip: int = 0, limit: int = 100):
        return self.repository.list(skip, limit)

    def update_estimate(self, estimate_number: int, estimate_data: dict):
    ...
    def get_customer_estimates(self, customer_code: str, skip: int = 0, limit: int = 100):
        return self.repository.get_by_customer_code(customer_code, skip, limit)

    def get_estimates_by_date_range(self, start_date: datetime, end_date: datetime, skip: int = 0, limit: int = 100):
    ...
    def mark_estimate_as_ordered(self, estimate_number: int):
